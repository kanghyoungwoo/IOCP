...
| chatMin=150~450 | L16/IO8 | 🔴 lat_avg 138ms · 접속자 미달(7,716명) · 24,024 disconnects | ❌ **lat_avg 1,402ms · 35 disconnects (IO 병목)** |
| chatMin=200~600 | L16/IO8 | 🔴 lat_avg 27ms · 접속자 미달(7,975명) · 48,070 disconnects | ✅ lat_avg ~12ms · 0 disconnects |
...
> 100–300ms 구간에서는 **L8/IO16(IO=16)** 구성이 ~8ms 레이턴시를 달성합니다. 50–150ms 극고빈도 구간은 v3와 동일하게 Strand 처리 용량 한계로 불안정하며, Logic Thread 증가보다 송신 간격 완화가 더 효과적입니다.
